...
public class NeuralQueryBuilder extends AbstractQueryBuilder<NeuralQueryBuilder> implements ModelInferenceQueryBuilder {
    ...
    private QueryBuilder rewriteQueryAgainstSemanticFieldOnShard(QueryShardContext shardContext) {
        ...
        if (mappedFieldType instanceof SemanticStringFieldType semanticTextFieldType) {
            final String modelIdFromIndex = semanticTextFieldType.getSemanticParameters().getModelId();
    ...
    private String getNestedQueryPath(SemanticStringFieldType semanticTextFieldType) {
    ...
    private QueryBuilder inference(QueryCoordinatorContext queryRewriteContext) {
    ...
    private List<String> collectModelIds(List<IndexService> targetIndexServices, String fieldName) {
        ...
        for (IndexService indexService : targetIndexServices) {
            ...
            if (mappedFieldType instanceof SemanticStringFieldType) {
                SemanticStringFieldType semanticTextFieldType = (SemanticStringFieldType) mappedFieldType;
                String modelIdFromIndex = semanticTextFieldType.getSemanticParameters().getModelId();
                if (modelIdFromIndex != null) {
