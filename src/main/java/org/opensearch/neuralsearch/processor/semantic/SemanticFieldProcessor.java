...
public class SemanticFieldProcessor extends AbstractBatchingSystemProcessor {
     ...
     * So in this function we simply return the doc directly so that the doc will not be dropped.
    ...
    private void generateEmbedding(
        ...
        final Map<Pair<String, String>, Object> modelIdValueToEmbeddingMap = new ConcurrentHashMap<>();
