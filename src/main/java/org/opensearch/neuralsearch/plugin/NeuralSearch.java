...
public class NeuralSearch extends Plugin
    ...
    public Map<String, Processor.Factory> getInternalProcessors(Processor.Parameters parameters) {
        ...
        return Map.of(
            ...
            new SemanticFieldProcessorFactory(clientAccessor, parameters.env, parameters.ingestService.getClusterService())
        );
    }
    ...
    public Map<String, Mapper.TypeParser> getMappers() {
        return Collections.singletonMap(SemanticTextFieldMapper.CONTENT_TYPE, new SemanticTextFieldMapper.TypeParser(clientAccessor));
    }
}
