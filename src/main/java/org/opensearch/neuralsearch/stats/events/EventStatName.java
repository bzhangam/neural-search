...
public enum EventStatName implements StatName {
    ...
    NEURAL_QUERY_AGAINST_SEMANTIC_DENSE_COUNT("neural_query_against_semantic_dense_requests", "query.neural", EventStatType.TIMESTAMPED_EVENT_COUNTER),
    NEURAL_QUERY_AGAINST_SEMANTIC_SPARSE_COUNT("neural_query_against_semantic_sparse_requests", "query.neural", EventStatType.TIMESTAMPED_EVENT_COUNTER),
